        ...
        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="600" class="container" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
          ...
          <tr>
            <td style="background-color: #2D3748; padding: 30px; text-align: center;">
              ...
              <p style="margin: 20px 0 0 0; color: #718096; font-size: 10px; font-family: 'Quicksand', sans-serif;">© 2025 NannySitting.</p>
            </td>
          </tr>
        </table>
    ...
    <tr>
      <td align="center" style="padding: 40px 0;">
        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="600" class="container" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
          ...
          <tr>
            <td class="mobile-padding" style="padding: 40px 50px;">
              <h1 style="margin: 0 0 20px 0; font-family: 'Quicksand', sans-serif; font-size: 24px; color: #2D3748; font-weight: 700; text-align: center;">Nouvelle demande de ${firstName} ${lastName} ! ✨</h1>
              <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 1.6; color: #4A5568; text-align: center; font-family: 'Quicksand', sans-serif;">
                Une famille a rempli le formulaire de contact sur votre site. Voici les détails de sa demande.
              </p>
              <div style="background-color: #FFF4ED; border: 1px solid #F79B75; border-radius: 8px; padding: 15px; margin-bottom: 30px; text-align: center;">
                <p style="margin: 0; color: #2D3748; font-weight: 600; font-size: 14px; font-family: 'Quicksand', sans-serif;">
                  📋 Service demandé : <span style="color: #F79B75; font-weight: 700;">${data.service}</span>
                </p>
              </div>
              <p style="font-size: 14px; color: #81B7A9; font-weight: 700; text-transform: uppercase; margin-bottom: 15px; text-align: center; font-family: 'Quicksand', sans-serif;">
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #F8FAFC; border-radius: 12px; overflow: hidden;">
                <tr>
                  <td style="padding: 20px 25px; border-bottom: 1px solid #EDF2F7;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td class="col-mobile" width="50%" style="vertical-align: top; padding-right: 10px;">
                          <p style="margin: 0 0 5px 0; font-size: 11px; color: #A0AEC0; text-transform: uppercase; font-weight: bold;">Prénom</p>
                          <p style="margin: 0; font-size: 15px; color: #2D3748; font-weight: 600;">${firstName}</p>
                        </td>
                        <td class="col-mobile" width="50%" style="vertical-align: top;">
                          <p style="margin: 0 0 5px 0; font-size: 11px; color: #A0AEC0; text-transform: uppercase; font-weight: bold;">Nom</p>
                          <p style="margin: 0; font-size: 15px; color: #2D3748; font-weight: 600;">${lastName}</p>
                        </td>
                      </tr>
                    </table>
                  </td>
                  ...
                  <td style="padding: 20px 25px; border-bottom: 1px solid #EDF2F7;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td class="col-mobile" width="50%" style="vertical-align: top; padding-right: 10px;">
                          <p style="margin: 0 0 5px 0; font-size: 11px; color: #A0AEC0; text-transform: uppercase; font-weight: bold;">Email</p>
                          <p style="margin: 0; font-size: 15px; color: #2D3748;"><a href="mailto:${data.email}" style="color: #2D3748; text-decoration: underline;">${data.email}</a></p>
                        </td>
                        <td class="col-mobile" width="50%" style="vertical-align: top;">
                          <p style="margin: 0 0 5px 0; font-size: 11px; color: #A0AEC0; text-transform: uppercase; font-weight: bold;">Téléphone</p>
                          <p style="margin: 0; font-size: 15px; color: #2D3748;"><a href="tel:${data.phone}" style="color: #2D3748; text-decoration: underline;">${data.phone}</a></p>
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  <td style="padding: 20px 25px;">
                    <p style="margin: 0 0 5px 0; font-size: 11px; color: #A0AEC0; text-transform: uppercase; font-weight: bold;">Détails / Message</p>
                    <p style="margin: 0; font-size: 14px; color: #4A5568; line-height: 1.5; font-style: italic;">"${data.message || 'Aucun message spécifique'}"</p>
                  </td>
                </tr>
              </table>
            </td>
        ...
        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="600" class="container">
           <tr>
             <td align="center" style="padding-top: 20px;">
               <p style="font-size: 10px; color: #A0AEC0; font-family: 'Quicksand', sans-serif;">Notification automatique - Nouvelle demande client.</p>
             </td>
           </tr>
        </table>
      </td>
