...
<p style="margin: 0 0 20px 0; color: #F79B75 !important; font-size: 32px; font-weight: bold; font-family: 'Quicksand', sans-serif;">${invoice.montant_ttc?.toFixed(2)} €</p>
<p style="margin: 0 0 5px 0; color: #81B7A9 !important; font-size: 12px; font-weight: bold; text-transform: uppercase; font-family: 'Quicksand', sans-serif;">Date d'échéance</p>
<p style="margin: 0; color: #2D3748 !important; font-size: 16px; font-weight: bold; font-family: 'Quicksand', sans-serif;">${invoice.date_echeance ? new Date(invoice.date_echeance).toLocaleDateString('fr-FR') : 'Non spécifiée'}</p>
</td>
</tr>
</table>
...
<p style="font-size: 14px; color: #718096 !important; text-align: center; margin-bottom: 10px; font-family: 'Quicksand', sans-serif;">Merci de procéder au règlement avant la date d'échéance indiquée.</p>
</td>
</tr>
<tr>
